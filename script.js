...
async function imageExists(url) {
    if (!url) return false;  // Skip check if URL is empty or undefined
    try {
...
// Function to create event section, handling optional images
async function createEventSection(event, container) {
    ...
    // Add the image only if it exists and passes the URL check
    let imageHtml = '';
